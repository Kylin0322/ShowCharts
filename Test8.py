...
from pyecharts.charts import Bar, Gauge, Page, Pie
...
class show_chart():
    ...
    def add_gauge_FPY_efficiency(self):
        self.chart_gauge_FPY_efficiency = (
    ...
    def show(self):
        ...
        self.chart_gauge_FPY_efficiency.render("FPY_Efficiency.html")
...
if __name__ == '__main__':
    ...
    chart1.add_gauge_FPY_efficiency()
    chart1.add_bar_UPH()
